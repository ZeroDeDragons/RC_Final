                ...
                <div class="criar-form">
                    <form id="form-criar-ponto">
                        ...
                        <div class="form-grupo">
                            ...
                            <select id="campo-categoria" name="categoria_id" required>
                                <option value="">Seleciona uma categoria</option>
                                <?php foreach ($categorias as $cat): ?>
                                <option value="<?php echo $cat['CategoriaID']; ?>">
                        ...
                        <div id="campo-nova-categoria" class="form-grupo" style="display: none;">
                            ...
                            <div class="nova-categoria-grid">
                                ...
                                <input type="text" id="nova-categoria-letra" placeholder="Letra" maxlength="1">
                            </div>
                        </div>
